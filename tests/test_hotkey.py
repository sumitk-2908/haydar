...
def test_hotkey_registration_failure(caplog):
    ...
    with (
        patch.dict(sys.modules, {"pynput": fake_pynput, "pynput.keyboard": fake_pynput}),
        patch("haydar.ui.hotkey.threading.Thread", side_effect=Exception("mocked permission error")),
